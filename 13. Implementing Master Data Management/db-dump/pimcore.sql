...
(1,	0,	'folder',	'',	'/',	NULL,	1618935840,	1618935840,	1,	1,	NULL,	0,	0);
...
(1,	0,	'page',	'',	'/',	999999,	1,	1618935840,	1618935840,	1,	1,	0);
...
(1,	0,	'folder',	'',	'/',	999999,	1,	1618935840,	1618935840,	1,	1,	NULL,	NULL,	NULL,	NULL,	0);
...
INSERT INTO `plugin_datahub_workspaces_asset` (`cid`, `cpath`, `configuration`, `create`, `read`, `update`, `delete`) VALUES
(2,	'/Products',	'my-datahub-configuration',	0,	1,	0,	0);
...
INSERT INTO `plugin_datahub_workspaces_object` (`cid`, `cpath`, `configuration`, `create`, `read`, `update`, `delete`) VALUES
(2,	'/Categories',	'my-datahub-configuration',	0,	1,	0,	0),
(9,	'/Colors',	'my-datahub-configuration',	0,	1,	0,	0),
(157,	'/Materials',	'my-datahub-configuration',	0,	1,	0,	0),
(161,	'/Products',	'my-datahub-configuration',	1,	1,	1,	1);
...
(2,	0,	'user',	'admin',	'$2y$10$sJDE7TgaO4W8fdCj0Fje9.6Ybx9Q2vo1bX56PNGlljRcug9e0ES/O',	NULL,	NULL,	NULL,	'en',	NULL,	1,	1,	'',	'',	0,	1,	1,	0,	'',	'',	'null',	NULL,	'',	'',	'',	1618935900,	NULL);
...
CREATE ALGORITHM=UNDEFINED SQL SECURITY DEFINER VIEW `object_localized_CAT_el_GR` AS select `object_query_CAT`.`oo_id` AS `oo_id`,`object_query_CAT`.`oo_classId` AS `oo_classId`,`object_query_CAT`.`oo_className` AS `oo_className`,`object_query_CAT`.`code` AS `code`,`objects`.`o_id` AS `o_id`,`objects`.`o_parentId` AS `o_parentId`,`objects`.`o_type` AS `o_type`,`objects`.`o_key` AS `o_key`,`objects`.`o_path` AS `o_path`,`objects`.`o_index` AS `o_index`,`objects`.`o_published` AS `o_published`,`objects`.`o_creationDate` AS `o_creationDate`,`objects`.`o_modificationDate` AS `o_modificationDate`,`objects`.`o_userOwner` AS `o_userOwner`,`objects`.`o_userModification` AS `o_userModification`,`objects`.`o_classId` AS `o_classId`,`objects`.`o_className` AS `o_className`,`objects`.`o_childrenSortBy` AS `o_childrenSortBy`,`objects`.`o_childrenSortOrder` AS `o_childrenSortOrder`,`objects`.`o_versionCount` AS `o_versionCount`,`el_GR`.`ooo_id` AS `ooo_id`,`el_GR`.`language` AS `language`,`el_GR`.`name` AS `name`,`el_GR`.`description` AS `description` from ((`object_query_CAT` join `objects` on(`objects`.`o_id` = `object_query_CAT`.`oo_id`)) left join `object_localized_query_CAT_el_GR` `el_GR` on(1 and `object_query_CAT`.`oo_id` = `el_GR`.`ooo_id`));
