...
(1,	0,	'folder',	'',	'/',	NULL,	1618934110,	1618934110,	1,	1,	NULL,	0,	0);
...
(1,	0,	'page',	'',	'/',	999999,	1,	1618934110,	1618934110,	1,	1,	0);
...
(1,	0,	'folder',	'',	'/',	999999,	1,	1618934110,	1618934110,	1,	1,	NULL,	NULL,	NULL,	NULL,	0);
...
CREATE TABLE `object_CAT` (`oo_id` int(11), `oo_classId` varchar(50), `oo_className` varchar(255), `code` varchar(190), `o_id` int(11) unsigned, `o_parentId` int(11) unsigned, `o_type` enum('object','folder','variant'), `o_key` varchar(255), `o_path` varchar(765), `o_index` int(11) unsigned, `o_published` tinyint(1) unsigned, `o_creationDate` int(11) unsigned, `o_modificationDate` int(11) unsigned, `o_userOwner` int(11) unsigned, `o_userModification` int(11) unsigned, `o_classId` varchar(50), `o_className` varchar(255), `o_childrenSortBy` enum('key','index'), `o_childrenSortOrder` enum('ASC','DESC'), `o_versionCount` int(10) unsigned);


DROP VIEW IF EXISTS `object_COL`;
CREATE TABLE `object_COL` (`oo_id` int(11), `oo_classId` varchar(50), `oo_className` varchar(255), `name` varchar(190), `color__rgb` varchar(6), `color__a` varchar(2), `o_id` int(11) unsigned, `o_parentId` int(11) unsigned, `o_type` enum('object','folder','variant'), `o_key` varchar(255), `o_path` varchar(765), `o_index` int(11) unsigned, `o_published` tinyint(1) unsigned, `o_creationDate` int(11) unsigned, `o_modificationDate` int(11) unsigned, `o_userOwner` int(11) unsigned, `o_userModification` int(11) unsigned, `o_classId` varchar(50), `o_className` varchar(255), `o_childrenSortBy` enum('key','index'), `o_childrenSortOrder` enum('ASC','DESC'), `o_versionCount` int(10) unsigned);
...
CREATE TABLE `object_localized_PRD_en` (`oo_id` int(11), `oo_classId` varchar(50), `oo_className` varchar(255), `sku` varchar(190), `price__value` double, `price__unit` varchar(50), `bundlePrice` double, `bundle_products` text, `brand` varchar(190), `made_in` varchar(190), `category__id` int(11), `category__type` enum('document','asset','object'), `materials` text, `color__id` int(11), `color__type` enum('document','asset','object'), `o_id` int(11) unsigned, `o_parentId` int(11) unsigned, `o_type` enum('object','folder','variant'), `o_key` varchar(255), `o_path` varchar(765), `o_index` int(11) unsigned, `o_published` tinyint(1) unsigned, `o_creationDate` int(11) unsigned, `o_modificationDate` int(11) unsigned, `o_userOwner` int(11) unsigned, `o_userModification` int(11) unsigned, `o_classId` varchar(50), `o_className` varchar(255), `o_childrenSortBy` enum('key','index'), `o_childrenSortOrder` enum('ASC','DESC'), `o_versionCount` int(10) unsigned, `ooo_id` int(11), `language` varchar(10), `name` varchar(190), `short_description` longtext, `description` longtext);
...
CREATE TABLE `object_PRD` (`oo_id` int(11), `oo_classId` varchar(50), `oo_className` varchar(255), `sku` varchar(190), `price__value` double, `price__unit` varchar(50), `bundlePrice` double, `bundle_products` text, `brand` varchar(190), `made_in` varchar(190), `category__id` int(11), `category__type` enum('document','asset','object'), `materials` text, `color__id` int(11), `color__type` enum('document','asset','object'), `o_id` int(11) unsigned, `o_parentId` int(11) unsigned, `o_type` enum('object','folder','variant'), `o_key` varchar(255), `o_path` varchar(765), `o_index` int(11) unsigned, `o_published` tinyint(1) unsigned, `o_creationDate` int(11) unsigned, `o_modificationDate` int(11) unsigned, `o_userOwner` int(11) unsigned, `o_userModification` int(11) unsigned, `o_classId` varchar(50), `o_className` varchar(255), `o_childrenSortBy` enum('key','index'), `o_childrenSortOrder` enum('ASC','DESC'), `o_versionCount` int(10) unsigned);
...
('Category',	NULL,	'cs',	'',	1618934535,	1618934535),
('Category',	NULL,	'de',	'',	1618934535,	1618934535),
('Category',	NULL,	'en',	'',	1618934535,	1618934535),
('Category',	NULL,	'es',	'',	1618934535,	1618934535),
('Category',	NULL,	'fa',	'',	1618934535,	1618934535),
('Category',	NULL,	'fr',	'',	1618934535,	1618934535),
('Category',	NULL,	'hu',	'',	1618934535,	1618934535),
('Category',	NULL,	'it',	'',	1618934535,	1618934535),
('Category',	NULL,	'ja',	'',	1618934535,	1618934535),
('Category',	NULL,	'nl',	'',	1618934535,	1618934535),
('Category',	NULL,	'pl',	'',	1618934535,	1618934535),
('Category',	NULL,	'pt_BR',	'',	1618934535,	1618934535),
('Category',	NULL,	'ru',	'',	1618934535,	1618934535),
('Category',	NULL,	'sk',	'',	1618934535,	1618934535),
('Category',	NULL,	'sv',	'',	1618934535,	1618934535),
('Category',	NULL,	'sv_FI',	'',	1618934535,	1618934535),
('Category',	NULL,	'th',	'',	1618934535,	1618934535),
('Category',	NULL,	'tr',	'',	1618934535,	1618934535),
('Category',	NULL,	'uk',	'',	1618934535,	1618934535),
('Category',	NULL,	'zh_Hans',	'',	1618934535,	1618934535),
('Color',	NULL,	'cs',	'',	1618934535,	1618934535),
('Color',	NULL,	'de',	'',	1618934535,	1618934535),
('Color',	NULL,	'en',	'',	1618934535,	1618934535),
('Color',	NULL,	'es',	'',	1618934535,	1618934535),
('Color',	NULL,	'fa',	'',	1618934535,	1618934535),
('Color',	NULL,	'fr',	'',	1618934535,	1618934535),
('Color',	NULL,	'hu',	'',	1618934535,	1618934535),
('Color',	NULL,	'it',	'',	1618934535,	1618934535),
('Color',	NULL,	'ja',	'',	1618934535,	1618934535),
('Color',	NULL,	'nl',	'',	1618934535,	1618934535),
('Color',	NULL,	'pl',	'',	1618934535,	1618934535),
('Color',	NULL,	'pt_BR',	'',	1618934535,	1618934535),
('Color',	NULL,	'ru',	'',	1618934535,	1618934535),
('Color',	NULL,	'sk',	'',	1618934535,	1618934535),
('Color',	NULL,	'sv',	'',	1618934535,	1618934535),
('Color',	NULL,	'sv_FI',	'',	1618934535,	1618934535),
('Color',	NULL,	'th',	'',	1618934535,	1618934535),
('Color',	NULL,	'tr',	'',	1618934535,	1618934535),
('Color',	NULL,	'uk',	'',	1618934535,	1618934535),
('Color',	NULL,	'zh_Hans',	'',	1618934535,	1618934535),
('Material',	NULL,	'cs',	'',	1618934535,	1618934535),
('Material',	NULL,	'de',	'',	1618934535,	1618934535),
('Material',	NULL,	'en',	'',	1618934535,	1618934535),
('Material',	NULL,	'es',	'',	1618934535,	1618934535),
('Material',	NULL,	'fa',	'',	1618934535,	1618934535),
('Material',	NULL,	'fr',	'',	1618934535,	1618934535),
('Material',	NULL,	'hu',	'',	1618934535,	1618934535),
('Material',	NULL,	'it',	'',	1618934535,	1618934535),
('Material',	NULL,	'ja',	'',	1618934535,	1618934535),
('Material',	NULL,	'nl',	'',	1618934535,	1618934535),
('Material',	NULL,	'pl',	'',	1618934535,	1618934535),
('Material',	NULL,	'pt_BR',	'',	1618934535,	1618934535),
('Material',	NULL,	'ru',	'',	1618934535,	1618934535),
('Material',	NULL,	'sk',	'',	1618934535,	1618934535),
('Material',	NULL,	'sv',	'',	1618934535,	1618934535),
('Material',	NULL,	'sv_FI',	'',	1618934535,	1618934535),
('Material',	NULL,	'th',	'',	1618934535,	1618934535),
('Material',	NULL,	'tr',	'',	1618934535,	1618934535),
('Material',	NULL,	'uk',	'',	1618934535,	1618934535),
('Material',	NULL,	'zh_Hans',	'',	1618934535,	1618934535),
('Product',	NULL,	'cs',	'',	1618934535,	1618934535),
('Product',	NULL,	'de',	'',	1618934535,	1618934535),
('Product',	NULL,	'en',	'',	1618934535,	1618934535),
('Product',	NULL,	'es',	'',	1618934535,	1618934535),
('Product',	NULL,	'fa',	'',	1618934535,	1618934535),
('Product',	NULL,	'fr',	'',	1618934535,	1618934535),
('Product',	NULL,	'hu',	'',	1618934535,	1618934535),
('Product',	NULL,	'it',	'',	1618934535,	1618934535),
('Product',	NULL,	'ja',	'',	1618934535,	1618934535),
('Product',	NULL,	'nl',	'',	1618934535,	1618934535),
('Product',	NULL,	'pl',	'',	1618934535,	1618934535),
('Product',	NULL,	'pt_BR',	'',	1618934535,	1618934535),
('Product',	NULL,	'ru',	'',	1618934535,	1618934535),
('Product',	NULL,	'sk',	'',	1618934535,	1618934535),
('Product',	NULL,	'sv',	'',	1618934535,	1618934535),
('Product',	NULL,	'sv_FI',	'',	1618934535,	1618934535),
('Product',	NULL,	'th',	'',	1618934535,	1618934535),
('Product',	NULL,	'tr',	'',	1618934535,	1618934535),
('Product',	NULL,	'uk',	'',	1618934535,	1618934535),
('Product',	NULL,	'zh_Hans',	'',	1618934535,	1618934535),
('login',	NULL,	'en',	'',	1618934528,	1618934528);
...
(2,	0,	'user',	'admin',	'$2y$10$eXIDeDUy6WSuH/SiGvsXreM9q8xsZ235Qf6lCtw6lSdExiM0u4vOm',	NULL,	NULL,	NULL,	'en',	NULL,	1,	1,	'',	'',	0,	1,	1,	0,	'',	'',	'null',	NULL,	'',	'',	'',	1618934534,	NULL);
...
CREATE ALGORITHM=UNDEFINED SQL SECURITY DEFINER VIEW `object_COL` AS select `object_query_COL`.`oo_id` AS `oo_id`,`object_query_COL`.`oo_classId` AS `oo_classId`,`object_query_COL`.`oo_className` AS `oo_className`,`object_query_COL`.`name` AS `name`,`object_query_COL`.`color__rgb` AS `color__rgb`,`object_query_COL`.`color__a` AS `color__a`,`objects`.`o_id` AS `o_id`,`objects`.`o_parentId` AS `o_parentId`,`objects`.`o_type` AS `o_type`,`objects`.`o_key` AS `o_key`,`objects`.`o_path` AS `o_path`,`objects`.`o_index` AS `o_index`,`objects`.`o_published` AS `o_published`,`objects`.`o_creationDate` AS `o_creationDate`,`objects`.`o_modificationDate` AS `o_modificationDate`,`objects`.`o_userOwner` AS `o_userOwner`,`objects`.`o_userModification` AS `o_userModification`,`objects`.`o_classId` AS `o_classId`,`objects`.`o_className` AS `o_className`,`objects`.`o_childrenSortBy` AS `o_childrenSortBy`,`objects`.`o_childrenSortOrder` AS `o_childrenSortOrder`,`objects`.`o_versionCount` AS `o_versionCount` from (`object_query_COL` join `objects` on(`objects`.`o_id` = `object_query_COL`.`oo_id`));
...
CREATE ALGORITHM=UNDEFINED SQL SECURITY DEFINER VIEW `object_localized_PRD_en` AS select `object_query_PRD`.`oo_id` AS `oo_id`,`object_query_PRD`.`oo_classId` AS `oo_classId`,`object_query_PRD`.`oo_className` AS `oo_className`,`object_query_PRD`.`sku` AS `sku`,`object_query_PRD`.`price__value` AS `price__value`,`object_query_PRD`.`price__unit` AS `price__unit`,`object_query_PRD`.`bundlePrice` AS `bundlePrice`,`object_query_PRD`.`bundle_products` AS `bundle_products`,`object_query_PRD`.`brand` AS `brand`,`object_query_PRD`.`made_in` AS `made_in`,`object_query_PRD`.`category__id` AS `category__id`,`object_query_PRD`.`category__type` AS `category__type`,`object_query_PRD`.`materials` AS `materials`,`object_query_PRD`.`color__id` AS `color__id`,`object_query_PRD`.`color__type` AS `color__type`,`objects`.`o_id` AS `o_id`,`objects`.`o_parentId` AS `o_parentId`,`objects`.`o_type` AS `o_type`,`objects`.`o_key` AS `o_key`,`objects`.`o_path` AS `o_path`,`objects`.`o_index` AS `o_index`,`objects`.`o_published` AS `o_published`,`objects`.`o_creationDate` AS `o_creationDate`,`objects`.`o_modificationDate` AS `o_modificationDate`,`objects`.`o_userOwner` AS `o_userOwner`,`objects`.`o_userModification` AS `o_userModification`,`objects`.`o_classId` AS `o_classId`,`objects`.`o_className` AS `o_className`,`objects`.`o_childrenSortBy` AS `o_childrenSortBy`,`objects`.`o_childrenSortOrder` AS `o_childrenSortOrder`,`objects`.`o_versionCount` AS `o_versionCount`,`en`.`ooo_id` AS `ooo_id`,`en`.`language` AS `language`,`en`.`name` AS `name`,`en`.`short_description` AS `short_description`,`en`.`description` AS `description` from ((`object_query_PRD` join `objects` on(`objects`.`o_id` = `object_query_PRD`.`oo_id`)) left join `object_localized_query_PRD_en` `en` on(1 and `object_query_PRD`.`oo_id` = `en`.`ooo_id`));
