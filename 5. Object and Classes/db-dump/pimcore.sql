...
(1,	0,	'folder',	'',	'/',	NULL,	1618900261,	1618900261,	1,	1,	NULL,	0,	0);
...
(1,	0,	'page',	'',	'/',	999999,	1,	1618900261,	1618900261,	1,	1,	0);
...
(1,	0,	'folder',	'',	'/',	999999,	1,	1618900261,	1618900261,	1,	1,	NULL,	NULL,	NULL,	NULL,	0);
...
CREATE TABLE `object_CAT` (`oo_id` int(11), `oo_classId` varchar(50), `oo_className` varchar(255), `products` text, `name` varchar(190), `code` varchar(190), `o_id` int(11) unsigned, `o_parentId` int(11) unsigned, `o_type` enum('object','folder','variant'), `o_key` varchar(255), `o_path` varchar(765), `o_index` int(11) unsigned, `o_published` tinyint(1) unsigned, `o_creationDate` int(11) unsigned, `o_modificationDate` int(11) unsigned, `o_userOwner` int(11) unsigned, `o_userModification` int(11) unsigned, `o_classId` varchar(50), `o_className` varchar(255), `o_childrenSortBy` enum('key','index'), `o_versionCount` int(10) unsigned);
...
CREATE TABLE `object_PROD` (`oo_id` int(11), `oo_classId` varchar(50), `oo_className` varchar(255), `categories` text, `title` varchar(190), `o_id` int(11) unsigned, `o_parentId` int(11) unsigned, `o_type` enum('object','folder','variant'), `o_key` varchar(255), `o_path` varchar(765), `o_index` int(11) unsigned, `o_published` tinyint(1) unsigned, `o_creationDate` int(11) unsigned, `o_modificationDate` int(11) unsigned, `o_userOwner` int(11) unsigned, `o_userModification` int(11) unsigned, `o_classId` varchar(50), `o_className` varchar(255), `o_childrenSortBy` enum('key','index'), `o_versionCount` int(10) unsigned);
...
(5,	'CAT',	'Category',	NULL,	'T-Shirts',	'TSH'),
(6,	'CAT',	'Category',	NULL,	'Limited Edition',	'LIM');
...
(3,	'PROD',	'Product',	',5,6,',	'T-Shirts'),
(7,	'PROD',	'Product',	',5,6,',	'Black T-Shirts'),
(8,	'PROD',	'Product',	',5,6,',	'White T-Shirts');
...
(3,	5,	'object',	'categories',	1,	'object',	'',	'0'),
(3,	6,	'object',	'categories',	2,	'object',	'',	'0'),
(3,	5,	'object',	'test',	1,	'object',	'',	'0'),
(3,	6,	'object',	'test',	2,	'object',	'',	'0');
...
('login',	NULL,	'en',	'',	1618900293,	1618900293),
('login',	NULL,	'it',	'',	1618900293,	1618900293),
('test',	NULL,	'cs',	'',	1618900452,	1618900452),
('test',	NULL,	'de',	'',	1618900452,	1618900452),
('test',	NULL,	'en',	'',	1618900452,	1618900452),
('test',	NULL,	'es',	'',	1618900452,	1618900452),
('test',	NULL,	'fa',	'',	1618900452,	1618900452),
('test',	NULL,	'fr',	'',	1618900452,	1618900452),
('test',	NULL,	'hu',	'',	1618900452,	1618900452),
('test',	NULL,	'it',	'',	1618900452,	1618900452),
('test',	NULL,	'ja',	'',	1618900452,	1618900452),
('test',	NULL,	'nl',	'',	1618900452,	1618900452),
('test',	NULL,	'pl',	'',	1618900452,	1618900452),
('test',	NULL,	'pt_BR',	'',	1618900452,	1618900452),
('test',	NULL,	'ru',	'',	1618900452,	1618900452),
('test',	NULL,	'sk',	'',	1618900452,	1618900452),
('test',	NULL,	'sv',	'',	1618900452,	1618900452),
('test',	NULL,	'sv_FI',	'',	1618900452,	1618900452),
('test',	NULL,	'th',	'',	1618900452,	1618900452),
('test',	NULL,	'tr',	'',	1618900452,	1618900452),
('test',	NULL,	'uk',	'',	1618900452,	1618900452),
('test',	NULL,	'zh_Hans',	'',	1618900452,	1618900452);
...
(2,	0,	'user',	'admin',	'$2y$10$nMst04P.kikCmygpjI3d8O.IVYQx84nEwCgtDQVj1UVqrpx6FbaGO',	NULL,	NULL,	NULL,	'en',	NULL,	1,	1,	'',	'',	0,	1,	1,	0,	'',	'',	'null',	NULL,	'',	'',	'',	1618900304,	NULL);
