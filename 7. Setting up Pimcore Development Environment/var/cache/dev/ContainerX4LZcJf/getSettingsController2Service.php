...
class getSettingsController2Service extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.za.1Wif'] ?? $container->load('get_ServiceLocator_Za_1WifService'))->withContext('Pimcore\\Bundle\\AdminBundle\\Controller\\Reports\\SettingsController', $container));
