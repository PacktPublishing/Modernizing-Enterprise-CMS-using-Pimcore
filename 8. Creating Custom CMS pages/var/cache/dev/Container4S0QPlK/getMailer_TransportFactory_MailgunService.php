...
class getMailer_TransportFactory_MailgunService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/vendor/symfony/symfony/src/Symfony/Component/Mailer/Bridge/Mailgun/Transport/MailgunTransportFactory.php';

        return new \Symfony\Component\Mailer\Bridge\Mailgun\Transport\MailgunTransportFactory(($container->services['event_dispatcher'] ?? $container->getEventDispatcherService()), NULL, ($container->privates['monolog.logger'] ?? $container->getMonolog_LoggerService()));
    }
}
