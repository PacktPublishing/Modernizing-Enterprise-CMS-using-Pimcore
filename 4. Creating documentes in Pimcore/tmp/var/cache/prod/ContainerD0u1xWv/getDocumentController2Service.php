...
include_once \dirname(__DIR__, 4).'/vendor/pimcore/pimcore/bundles/AdminBundle/Controller/Rest/Element/DocumentController.php';

return $this->services['Pimcore\\Bundle\\AdminBundle\\Controller\\Rest\\Element\\DocumentController'] = new \Pimcore\Bundle\AdminBundle\Controller\Rest\Element\DocumentController(($this->services['pimcore_admin.webservice.service'] ?? $this->load('getPimcoreAdmin_Webservice_ServiceService.php')));
