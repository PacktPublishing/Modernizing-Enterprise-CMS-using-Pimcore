...
class DoctrinePersister_a694024 extends \Scheb\TwoFactorBundle\Model\Persister\DoctrinePersister implements \ProxyManager\Proxy\VirtualProxyInterface
{
    ...
    {
        $this->initializer4216a && ($this->initializer4216a->__invoke($valueHolder194ac, $this, 'persist', array('user' => $user), $this->initializer4216a) || 1) && $this->valueHolder194ac = $valueHolder194ac;
        $this->valueHolder194ac->persist($user);
return;
    }
    ...
    public function __construct(\Doctrine\Common\Persistence\ObjectManager $om)
    {
        ...
        $this->valueHolder194ac->__construct($om);
    }
