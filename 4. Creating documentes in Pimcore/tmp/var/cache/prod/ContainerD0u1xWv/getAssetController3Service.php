...
// Returns the public 'Pimcore\Bundle\AdminBundle\Controller\Rest\Element\AssetController' shared autowired service.
...
include_once \dirname(__DIR__, 4).'/vendor/pimcore/pimcore/bundles/AdminBundle/Controller/Rest/Element/AbstractElementController.php';
include_once \dirname(__DIR__, 4).'/vendor/pimcore/pimcore/bundles/AdminBundle/Controller/Rest/Element/AssetController.php';

return $this->services['Pimcore\\Bundle\\AdminBundle\\Controller\\Rest\\Element\\AssetController'] = new \Pimcore\Bundle\AdminBundle\Controller\Rest\Element\AssetController(($this->services['pimcore_admin.webservice.service'] ?? $this->load('getPimcoreAdmin_Webservice_ServiceService.php')));
