...
// Returns the private 'security.authentication.provider.guard.webservice.two_factor_decorator' shared service.
...
return $this->privates['security.authentication.provider.guard.webservice.two_factor_decorator'] = new \Scheb\TwoFactorBundle\Security\Authentication\Provider\AuthenticationProviderDecorator(new \Symfony\Component\Security\Guard\Provider\GuardAuthenticationProvider(new RewindableGenerator(function () {
