...
// Returns the public 'Pimcore\Bundle\AdminBundle\Controller\Rest\InfoController' shared autowired service.
...
include_once \dirname(__DIR__, 4).'/vendor/pimcore/pimcore/bundles/AdminBundle/Controller/Rest/InfoController.php';

return $this->services['Pimcore\\Bundle\\AdminBundle\\Controller\\Rest\\InfoController'] = new \Pimcore\Bundle\AdminBundle\Controller\Rest\InfoController(($this->services['pimcore_admin.webservice.service'] ?? $this->load('getPimcoreAdmin_Webservice_ServiceService.php')));
