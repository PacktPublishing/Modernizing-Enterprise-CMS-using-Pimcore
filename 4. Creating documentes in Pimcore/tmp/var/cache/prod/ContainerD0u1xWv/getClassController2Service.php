...
include_once \dirname(__DIR__, 4).'/vendor/pimcore/pimcore/bundles/AdminBundle/Controller/Rest/ClassController.php';

return $this->services['Pimcore\\Bundle\\AdminBundle\\Controller\\Rest\\ClassController'] = new \Pimcore\Bundle\AdminBundle\Controller\Rest\ClassController(($this->services['pimcore_admin.webservice.service'] ?? $this->load('getPimcoreAdmin_Webservice_ServiceService.php')));
