...
include_once \dirname(__DIR__, 4).'/vendor/pimcore/pimcore/bundles/AdminBundle/Controller/Rest/Element/TagController.php';

return $this->services['Pimcore\\Bundle\\AdminBundle\\Controller\\Rest\\Element\\TagController'] = new \Pimcore\Bundle\AdminBundle\Controller\Rest\Element\TagController(($this->services['pimcore_admin.webservice.service'] ?? $this->load('getPimcoreAdmin_Webservice_ServiceService.php')));
